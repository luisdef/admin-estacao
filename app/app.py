...
class App:
    ...
    def tela(self):
        self.root.title('Painel de Administração Estação Meteorológica IFRS Campus Feliz')
    ...
    def lista_estacao(self):
        ...
        self.listaUser.heading('#0', text='ID')
        self.listaUser.heading('#1', text='Data')
        self.listaUser.heading('#2', text='Horário')
        self.listaUser.heading('#3', text='Temperatura')
        self.listaUser.heading('#4', text='Umidade')
        self.listaUser.heading('#5', text='Pressão atm.')
        self.listaUser.heading('#6', text='Luminosidade')

        self.listaUser.column('#0', width=1)
        self.listaUser.column('#1', width=25)
        self.listaUser.column('#2', width=25)
        self.listaUser.column('#3', width=50)
        self.listaUser.column('#4', width=25)
    ...
    def lista_projetos(self):
        ...
        self.scrollLista = Scrollbar(self.aba2, orient='vertical')
        self.listaProj.configure(yscroll=self.scrollLista.set)
        self.scrollLista.place(relx=0.96, rely=0.2, relwidth=0.035, relheight=0.78)